...
public:
    ...
    void input(istream& in) { Person::inputMembers(in);
    						  if(!in) return;
...
bool Student::operator==(const Student& s) {
	return (*(Person*)this == (Person&)s) && (department == s.department) && (year == s.year);
}
...
public:
    ...
    void print(ostream& out) {	Person::printMembers(out);
...
bool Worker::operator== (const Worker& w) {
	return (*(Person*)this == (Person&)w) && (company == w.company) && (position == w.position);
}
...
public:
    ...
    bool operator==(const StudentWorker& a) {
    	return ( (*(Student*)this == (Student&)a) && (*(Worker*)this == (Worker&)a) && (this->male == a.male) );
    }
    void whatAreYouDoing();
};
